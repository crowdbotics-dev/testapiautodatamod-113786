...
## Project Structure
    ...
    ├── testapiautodatamod_113786  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_113786`
...
2. Clone this repo and `cd testapiautodatamod_113786`
